...
class Rudder {
  ...
  constructor(shipLength, shipBeam, shipMass,guifolder) {
    ...
    this.shipInertia = (1 / 1200) * shipMass * (shipLength ** 2 + shipBeam ** 2); // Moment of inertia for yaw
    ...
    guifolder
      .add(this, "rudderAngle", -35, 35, 10)
    guifolder
      .add(this, "angularAcceleration").listen()
    guifolder
      .add(this, "angularVelocity").listen()
  }
  updateMass(newMass) {
